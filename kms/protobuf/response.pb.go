...
var file_response_proto_rawDesc = []byte{
	...
	0x0c, 0x52, 0x0a, 0x63, 0x69, 0x70, 0x68, 0x65, 0x72, 0x74, 0x65, 0x78, 0x74, 0x42, 0x0e, 0x5a,
	0x0c, 0x6b, 0x6d, 0x73, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x62, 0x06, 0x70,
...
var file_response_proto_goTypes = []interface{}{
	...
	nil,                                // 13: minio.kms.ServerStatusResponse.NodesEntry
	nil,                                // 14: minio.kms.ClusterStatusResponse.NodesUpEntry
	nil,                                // 15: minio.kms.ClusterStatusResponse.NodesDownEntry
	(*durationpb.Duration)(nil),        // 16: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil),      // 17: google.protobuf.Timestamp
}
var file_response_proto_depIdxs = []int32{
	13, // 0: minio.kms.ServerStatusResponse.Nodes:type_name -> minio.kms.ServerStatusResponse.NodesEntry
	16, // 1: minio.kms.ServerStatusResponse.LastHeartbeat:type_name -> google.protobuf.Duration
	16, // 2: minio.kms.ServerStatusResponse.HeartbeatInterval:type_name -> google.protobuf.Duration
	16, // 3: minio.kms.ServerStatusResponse.ElectionTimeout:type_name -> google.protobuf.Duration
	16, // 4: minio.kms.ServerStatusResponse.UpTime:type_name -> google.protobuf.Duration
	14, // 5: minio.kms.ClusterStatusResponse.nodesUp:type_name -> minio.kms.ClusterStatusResponse.NodesUpEntry
	15, // 6: minio.kms.ClusterStatusResponse.nodesDown:type_name -> minio.kms.ClusterStatusResponse.NodesDownEntry
	17, // 7: minio.kms.DescribeEnclaveResponse.CreatedAt:type_name -> google.protobuf.Timestamp
	16, // 8: minio.kms.DescribeRouteResponse.Timeout:type_name -> google.protobuf.Duration
	5,  // 9: minio.kms.ListAPIsResponse.APIs:type_name -> minio.kms.DescribeRouteResponse
	17, // 10: minio.kms.DescribeKeyVersionResponse.CreatedAt:type_name -> google.protobuf.Timestamp
	2,  // 11: minio.kms.ClusterStatusResponse.NodesUpEntry.value:type_name -> minio.kms.ServerStatusResponse
